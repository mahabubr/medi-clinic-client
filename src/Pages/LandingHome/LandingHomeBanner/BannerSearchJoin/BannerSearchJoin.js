        ...
        <Box sx={{
            ...
            <Box sx={{ backgroundColor: '#ffffff', p: 5, gridColumnEnd: 'span 2', boxShadow: '5px 5px 15px #DDDDDD' }}>
                ...
                <Box onClick={toggleDrawer} sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', mt: 4 }}>
                    ...
                    <Typography ml={2} sx={{ cursor: 'pointer' }}>Advanced Search</Typography>
                </Box>
            </Box>
            <Box sx={{ p: 5, backgroundColor: '#2B3467' }}>
                <Typography color={"#fff"} variant="subtitle1">Are You A Doctor ?</Typography>
                <Typography color={'#ffffff'} variant="h4" fontWeight={800}>Join Our Team</Typography>
                <PrimaryButton style={{ marginTop: '20px' }}>Join As Doctor</PrimaryButton>
            </Box>
            <Drawer
                open={isOpen}
...
export default BannerSearchJoin;